...
while True:
    inp1 = input("Enter E to open excel and any other key to continue\t")
    if inp1 == "E" or inp1 == "e":
        os.startfile("DATABASE FOR BILLING.xlsx")
        clear()
        os.system("main.py")
        exit()
    else:
        ...
        while X == 0:
            for row in range(2, ws.max_row+1):
                ...
                if pch != phno and row == ws.max_row:
                    ...
                    break
        srNO = int(ws.max_row)
        billno = int(ws["H" + str(srNO)].value) + 1
